				...
				if(resultData.msg =="SUCCESS"){					
					...
					for(var i in resultData.info){
						...
						if(data.loginName!=null&&data.loginName!=''){
							...
							html += '<button type="button" data-bankCard="'+data.bank_card+'" data-bankAddr="'+data.bank_addr+'" data-userName="'+data.userName+'" data-userPhone="'+data.loginName+'" data-parentId="'+data.parentId+'"  data-card="'+data.card+'" data-status="'+data.buyStatus+'" data="'+data.loginName+'" class="gbtn det_btn">详情</button></td></tr>';						
					}
			        $(".show_List").html(html);
					...
					$(".det_btn").on("click",function(){
						...
						//	console.log($(this).attr("data-status"));
							...
							$("#bankCard").html($(this).attr("data-bankCard"));
							$("#bankAddr").html($(this).attr("data-bankAddr"));
